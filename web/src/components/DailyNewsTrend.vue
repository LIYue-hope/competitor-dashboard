...
.chart-option { display: inline-flex; align-items: center; gap: 4px; font-size: 12px; color: var(--text-2); cursor: pointer; }.tip-total { margin-top: 3px; color: var(--text); font-weight: 600; }
